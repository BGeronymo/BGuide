...
Este material trata-se de um manual de resoluções dos exercícios propostos no livro
*Um Curso de Cálculo, Volume 1, 5ª Edição* de *Hamilton Luiz Guidorizzi*. Ao decorrer das
resoluções o material busca apresentar, adicionalmente, resoluções
computacionais através do software
[R de computação estatística](https://www.r-project.org/) para facilitar a
visualização do problema e também o aprendizado da linguagem *R*.
...
<!--chapter:end:01-NumerosReais.Rmd-->
