...
##  O gráfico a seguir representa f1(x), f2(x) e g(x). Observe que para valores
## menores que -2 temos f1(x) > f2(x), para x = 1.5 temos f1(x) = f2(x) e para
## valores maiores que -2 temos f1(x) < f2(x).
